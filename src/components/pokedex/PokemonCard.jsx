...
import { bgByType, borderByType, colorTextByType } from "../../constants/pokemon";
...
const firstType = pokemon?.types[0].type.name
  ...
  return (
    <Link to={`/pokedex/${pokemon?.id}`} className={`capitalize border-8
     rounded-lg border-red-500 text-center ${borderByType[firstType]}`}>
      ...
      <div className="relative pt-14 ">
        ...
        <h3 className={`text-xl font-bold ${colorTextByType[firstType]}`}>{pokemon?.name}</h3>
